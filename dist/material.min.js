...
materialFramework.core_elements.icon = {
    ...
    prompt: function(a, b, c, d, e, f, g, h, i, j, k) {
        return this.prompt_form(a, b, c, d, function(a) {
            e(a[0]);
        }, f, [ {
            regexp: i,
            error_msg: j,
    ...
    prompt_form: function(a, b, c, d, e, f, g, h) {
        ...
        for (var j = "", k = "prompt-" + new Date().getTime(), l = !1, m = 0; m < g.length; m++) {
            var n = g[m];
            j += '<div style="margin-top: 10px"><input class="material-input" type="' + ("undefined" == typeof n.type ? "text" : n.type) + '" ', 
            "undefined" != typeof n.regexp && (l = !0, j += 'data-material-validation-group="' + k + '" data-material-regexp="' + n.regexp + '" data-material-error="' + n.error_msg + '" '), 
            "undefined" != typeof n.value && (j += 'value="' + n.value + '" '), j += ' placeholder="' + n.placeholder + '" ></div>';
        }
    ...
    custom: function(a, b) {
        ...
        return setTimeout(function() {
            c.obj.focus();
        }, 0), ("function" == typeof b || "undefined" == typeof b) && c.obj.find(">div>div").click(function(a) {
