...
materialFramework.core_elements.icon = {
    ...
    alert: function(a, b, c, d) {
        var e = {
            obj: $('<div class="material-alert" style="display: none"><div><div class="material-fadeout"><div class="material-z3"><p class="material-alert-header">' + a + "</p><p>" + b + '</p><div class="material-alert-bottom"> <button class="material-ink material-button material-prim-text-color">' + c + " </button></div></div></div></div></div>").appendTo("body").fadeIn(200),
            close: function() {
    ...
    custom: function(a, b) {
        var c = {
            obj: $('<div class="material-alert" style="display: none"><div><div class="material-fadeout"><div class="material-z3">' + a + "</div></div></div></div>").appendTo("body").fadeIn(200),
            close: function() {
                var a = this;
        ...
        return ("function" == typeof b || "undefined" == typeof b) && c.obj.find(">div>div").click(function(a) {
