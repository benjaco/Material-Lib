...
materialFramework.core_elements.icon = {
    ...
    add_require_element: function() {
        $(".material-icon:not([data-initilized])").attr("data-initilized", !0).each(function() {
            ...
            } else "onpropertychange" in document.body && (a[0].onpropertychange = function(b) {
                "data-icon" == b.propertyName && materialFramework.core_elements.icon.attrChanged(a);
            });
        });
    },
    ...
    alert: function(a, b, c, d) {
        var e = {
            obj: $('<div class="material-alert material-aml-alert" style="display: none"><div><div class="material-fadeout"><div class="material-z3"><p class="material-alert-header">' + a + "</p><p>" + b + '</p><div class="material-alert-bottom"> <button class="material-ink material-button material-prim-text-color">' + c + " </button></div></div></div></div></div>").appendTo("body").fadeIn(200),
            close: function() {
        ...
        return e.obj.find("button").focus().click(function() {
            e.close();
        }), e.obj.keydown(function(a) {
            a.stopPropagation(), 27 == a.which && e.close();
        }), ("function" == typeof d || "undefined" == typeof d) && e.obj.find(">div>div").click(function(a) {
            "material-fadeout" == a.target.className && ("function" == typeof d ? d(e) : e.close());
        }), e;
    },
    confirm: function(a, b, c, d, e, f, g) {
        var h = {
            obj: $('<div class="material-alert" style="display: none"><div><div class="material-fadeout"><div class="material-z3"><p class="material-alert-header">' + a + "</p><p>" + b + '</p><div class="material-alert-bottom"> <button class="material-ink material-button material-alert-confirm-fail">' + d + ' </button> <button class="material-ink material-button material-alert-confirm-ok material-prim-text-color">' + c + " </button></div></div></div></div></div>").appendTo("body").fadeIn(200),
            close: function() {
                this.isClosed = !0, this.obj.fadeOut(200, function() {
                    $(this).remove();
                });
            },
            isClosed: !1
        };
        return h.obj.find(".material-alert-confirm-ok").focus().click(function() {
            h.isClosed || (h.close(), e());
        }), h.obj.find(".material-alert-confirm-fail").click(function() {
            h.isClosed || (h.close(), f());
        }), h.obj.keydown(function(a) {
            h.isClosed || (a.stopPropagation(), 27 == a.which ? (h.close(), f()) : (37 == a.which || 38 == a.which || 39 == a.which || 40 == a.which || 9 == a.which) && (h.obj.find(".material-alert-confirm-ok").is(":focus") ? h.obj.find(".material-alert-confirm-fail").focus() : h.obj.find(".material-alert-confirm-ok").focus()));
        }), ("function" == typeof g || "undefined" == typeof g) && h.obj.find(">div>div").click(function(a) {
            "material-fadeout" == a.target.className && ("function" == typeof g ? g(h) : (f(), 
            h.close()));
        }), h;
    },
    custom: function(a, b) {
        ...
        return c.obj.focus(), ("function" == typeof b || "undefined" == typeof b) && c.obj.find(">div>div").click(function(a) {
