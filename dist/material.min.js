    ...
    add_require_element: function() {
        $('.material-checkbox[type="checkbox"]').hide(), $(".material-checkbox:not([data-initilized])").attr("data-initilized", !0).change(function() {
            ...
            9 == detectIE() ? a.next().find(".material-checkbox_inner").css(a[0].checked ? {
                ...
                bottom: 0,
                left: 0
            }) : $(this).parent().hasClass("material-no-animation") ? a.delay(250).next().find(".material-checkbox_inner").css(a[0].checked ? {
                borderColor: "#0f9d58",
                borderTop: "none",
                borderLeft: "none"
            } : {
        ...
        }).wrap("<label class='material-checkbox-label material-no-animation'></label>").parent().append("<div class='material-checkbox_outer' tabindex='0'>\n    <div class=\"material-checkbox_inner\"></div>\n</div>").append("<div class='material-checkbox_ink' ></div>").queue(function() {
